...
<body>
    <section class="container">
        ...
        <form class="formulario" method="POST" action="./fazer_cadastro.php">
            <fieldset class="dadoscadastro">
                ...
                <input type="date" id="data" name="dt_nascimento"/><br><br>
                ...
                <input type="radio" id="n-info" name="sexo" value="Não informado" class="custom-control-input">Prefiro não informar</label><br><br>
                
                <label for="cpf">CPF:</label><br>
                <input type="text" id="cpf" name="cpf" size="30" maxlength="14" onkeypress="mascaracpf(this)"/><br><br>
